...
class User < ActiveRecord::Base
  ...
  scope :elevator, lambda { where(:show_elevator => true) }
  scope :titled, lambda { where(:show_title => true) }
  ...
  def self.department_order
    order("
        CASE
          WHEN department = '1' THEN '1'
          WHEN department = '2' THEN '2'
          WHEN department = '3' THEN '3'
        END")
  end
