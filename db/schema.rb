...
ActiveRecord::Schema.define(version: 20170321140114) do
  ...
  add_index "albums", ["section_id"], name: "index_albums_on_section_id", using: :btree

  create_table "aldag_judges", force: :cascade do |t|
    ...
    t.boolean  "am"
    t.boolean  "pm"
    t.boolean  "attending_lunch"
    t.boolean  "attending_reception_and_awards"
  end

  create_table "aldag_reservations", force: :cascade do |t|
    t.string   "firstname",  limit: 255
    t.string   "lastname",   limit: 255
    t.string   "email",      limit: 255
    t.string   "phone",      limit: 255
    t.string   "advisor",    limit: 255
    t.text     "idea",       limit: 65535
    t.datetime "created_at",               null: false
    t.datetime "updated_at",               null: false
  end

  create_table "aldag_sponsors", force: :cascade do |t|
    t.string   "firstname",  limit: 255
    t.string   "lastname",   limit: 255
    t.string   "email",      limit: 255
    t.string   "phone",      limit: 255
  ...
  create_table "articles", force: :cascade do |t|
    ...
    t.string   "story_short_desc",   limit: 10000
  ...
  create_table "articles_news_categories", force: :cascade do |t|
  ...
  add_index "articles_news_categories", ["article_id"], name: "index_articles_news_categories_on_article_id", using: :btree
  add_index "articles_news_categories", ["news_category_id"], name: "index_articles_news_categories_on_news_category_id", using: :btree
  ...
  create_table "background_videos", force: :cascade do |t|
    t.string   "title",      limit: 255
    t.string   "location",   limit: 255
  ...
  create_table "banners", force: :cascade do |t|
    t.integer  "priority",       limit: 4
    t.text     "top_section",    limit: 65535
    t.text     "bottom_section", limit: 65535
    t.boolean  "status"
    t.datetime "created_at",                   null: false
    t.datetime "updated_at",                   null: false
  end

  create_table "bp_summaries", force: :cascade do |t|
    t.string   "pname",        limit: 255
    t.string   "pemail",       limit: 255
    t.string   "pphone",       limit: 255
    t.string   "t1name",       limit: 255
    t.string   "t1phone",      limit: 255
    t.string   "t1email",      limit: 255
    t.string   "t2name",       limit: 255
    t.string   "t2phone",      limit: 255
    t.string   "t2email",      limit: 255
    t.string   "t3name",       limit: 255
    t.string   "t3phone",      limit: 255
    t.string   "t3email",      limit: 255
    t.string   "fname",        limit: 255
    t.string   "fschool",      limit: 255
    t.string   "femail",       limit: 255
    t.string   "fphone",       limit: 255
    t.string   "businessname", limit: 255
    t.text     "bsummary",     limit: 65535
    t.text     "bproblem",     limit: 65535
    t.text     "bdesc",        limit: 65535
    t.text     "btarget",      limit: 65535
    t.text     "bmarketing",   limit: 65535
    t.text     "bfinancials",  limit: 65535
    t.text     "bhistory",     limit: 65535
    t.string   "bwebsite",     limit: 255
    t.text     "bplans",       limit: 65535
    t.string   "bgrandprize",  limit: 255
    t.datetime "created_at",                 null: false
    t.datetime "updated_at",                 null: false
    t.string   "preso",        limit: 255
    t.string   "finalpreso",   limit: 255
  end
  ...
  create_table "ca_applications", force: :cascade do |t|
    t.string   "name",                 limit: 255
    t.string   "email",                limit: 255
    t.text     "strengths",            limit: 65535
    t.string   "preferred_name",       limit: 255
  ...
  create_table "cldc_teams", force: :cascade do |t|
    t.string   "team_name",           limit: 255
    t.string   "team_captain",        limit: 255
    t.string   "team_captain_email",  limit: 255
    t.string   "team_captain_phone",  limit: 255
    t.string   "second_member_name",  limit: 255
    t.string   "second_member_email", limit: 255
    t.string   "third_member_name",   limit: 255
    t.string   "third_member_email",  limit: 255
    t.string   "advisor_title",       limit: 255
    t.string   "advisor_name",        limit: 255
    t.string   "advisor_phone",       limit: 255
    t.string   "advisor_email",       limit: 255
    t.string   "advisor_affiliation", limit: 255
    t.string   "resume1",             limit: 255
    t.string   "resume2",             limit: 255
    t.string   "resume3",             limit: 255
    t.datetime "created_at",                      null: false
    t.datetime "updated_at",                      null: false
  end
  ...
  create_table "concierges", force: :cascade do |t|
    ...
    t.text     "degrees",               limit: 65535
    t.date     "date_of_fill_position"
    t.boolean  "status"
    t.datetime "created_at",                          null: false
    t.datetime "updated_at",                          null: false
  end
  ...
  add_index "countdowns", ["section_id"], name: "index_countdowns_on_section_id", using: :btree
  ...
  create_table "events", force: :cascade do |t|
    ...
    t.string   "short_desc",        limit: 10000
    t.string   "desc",              limit: 10000
    t.boolean  "status"
  ...
  create_table "forms", force: :cascade do |t|
    t.string   "name",             limit: 255
    t.text     "description",      limit: 65535
    t.text     "success_text",     limit: 65535
    t.integer  "user_id",          limit: 4
    t.boolean  "email_on_submit"
    t.boolean  "notify_owner"
    t.boolean  "notify_submitter"
    t.string   "notify_subject",   limit: 255
    t.text     "notify_body",      limit: 65535
    t.datetime "created_at",                     null: false
    t.datetime "updated_at",                     null: false
  ...
  create_table "gphotos", force: :cascade do |t|
  ...
  add_index "gphotos", ["gallery_id"], name: "index_gphotos_on_gallery_id", using: :btree
  ...
  create_table "horizontal_imageboxes", force: :cascade do |t|
    t.integer  "page_id",    limit: 4
    t.integer  "section_id", limit: 4
    t.integer  "priority",   limit: 4
    t.string   "title",      limit: 255
  ...
  add_index "horizontal_imageboxes", ["page_id"], name: "index_horizontal_imageboxes_on_page_id", using: :btree
  add_index "horizontal_imageboxes", ["section_id"], name: "index_horizontal_imageboxes_on_section_id", using: :btree
  ...
  create_table "lift_courses", force: :cascade do |t|
    t.integer  "lift_session_id",  limit: 4
    t.string   "title",            limit: 255
    t.text     "description",      limit: 65535
    t.string   "location",         limit: 255
  ...
  create_table "lift_volunteers", force: :cascade do |t|
    t.integer  "lift_course_id", limit: 4
    t.string   "name",           limit: 255
    t.string   "email",          limit: 255
    t.string   "phone",          limit: 255
  ...
  add_index "lift_volunteers", ["lift_course_id"], name: "index_lift_volunteers_on_lift_course_id", using: :btree
  ...
  create_table "pages", force: :cascade do |t|
    ...
    t.integer  "department_id",    limit: 4
    t.string   "layout",           limit: 255
    t.integer  "bgstyle",          limit: 4
    t.string   "desc_bg_image",    limit: 255
  ...
  create_table "sections", force: :cascade do |t|
    ...
    t.boolean  "navlink"
    t.boolean  "showtitle"
    t.string   "background_image_uploader", limit: 255
    t.string   "section_bg_image",          limit: 255
    t.integer  "bgstyle",                   limit: 4
  end
  ...
  create_table "sp_applications", force: :cascade do |t|
    t.string   "firstname",            limit: 255
    t.string   "middleinitial",        limit: 255
    t.string   "lastname",             limit: 255
    t.string   "preferredname",        limit: 255
    t.string   "maddress",             limit: 255
    t.string   "city",                 limit: 255
    t.string   "state",                limit: 255
    t.string   "zipcode",              limit: 255
    t.string   "studentphone",         limit: 255
    t.string   "studentemail",         limit: 255
    t.string   "gender",               limit: 255
    t.string   "ethnicbackground",     limit: 255
    t.string   "tshirtshize",          limit: 255
    t.string   "poloshirt",            limit: 255
    t.string   "schoolname",           limit: 255
    t.string   "currentgpa",           limit: 255
    t.string   "actscore",             limit: 255
    t.string   "satscore",             limit: 255
    t.string   "currentgrade",         limit: 255
    t.string   "pfirstname",           limit: 255
    t.string   "plastname",            limit: 255
    t.string   "pphonenumber",         limit: 255
    t.string   "pemail",               limit: 255
    t.string   "programinterest",      limit: 255
    t.boolean  "previouslyapplied"
    t.string   "whichprogram",         limit: 255
    t.string   "pastattendance",       limit: 255
    t.string   "whichprogramattended", limit: 255
    t.string   "referral",             limit: 255
    t.string   "parentform",           limit: 255
    t.string   "transcript",           limit: 255
    t.string   "recletter",            limit: 255
    t.string   "rfirstname",           limit: 255
    t.string   "rlastname",            limit: 255
    t.string   "rphone",               limit: 255
    t.string   "remail",               limit: 255
  ...
  create_table "sp_contacts", force: :cascade do |t|
    t.string   "first_name", limit: 255
    t.string   "last_name",  limit: 255
    t.string   "email",      limit: 255
  ...
  create_table "stemapps", force: :cascade do |t|
    t.integer  "applicationtype", limit: 4
    t.string   "firstname",       limit: 255
    t.string   "lastname",        limit: 255
    t.boolean  "admitted"
    t.string   "cwid",            limit: 255
    t.text     "majors",          limit: 65535
    t.string   "uaemail",         limit: 255
    t.string   "otheremail",      limit: 255
  ...
  create_table "user_profiles", force: :cascade do |t|
    ...
    t.text     "description",          limit: 65535
    t.string   "url",                  limit: 255
    t.boolean  "link_to_profile"
    t.boolean  "show_contact_details"
    t.integer  "section_id",           limit: 4
    t.boolean  "status"
    t.datetime "created_at",                         null: false
    t.datetime "updated_at",                         null: false
  ...
  add_index "visit_reasons", ["visitor_id"], name: "index_visit_reasons_on_visitor_id", using: :btree
  ...
  add_foreign_key "albums", "sections"
  add_foreign_key "articles", "news_categories"
  add_foreign_key "articles", "users"
  add_foreign_key "articles_news_categories", "articles"
  add_foreign_key "articles_news_categories", "news_categories"
  ...
  add_foreign_key "countdowns", "sections"
  ...
  add_foreign_key "gphotos", "galleries"
  add_foreign_key "homepage_section_contents", "background_options"
  add_foreign_key "horizontal_imageboxes", "pages"
  add_foreign_key "horizontal_imageboxes", "sections"
  ...
  add_foreign_key "lift_volunteers", "lift_courses"
  ...
  add_foreign_key "visit_reasons", "visitors"
