...
================================================== -->
				...
				<div class="container">
					<div class="navbar-container">
						<div class="navbar-header">
							<a class="navbar-brand" title="The University of Alabama" rel="home" href="/">
							  <img class="pull-left img-responsive" alt="The University of Alabama" src="/assets/img/home.png" width="270" height="65">
  ...
  <li class="dropdown mega-menu-full">
    ...
    <div id="hero-slider">
		<div class="container">
            <div class="row">
			<iframe src="https://player.vimeo.com/video/191039780" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
		...
		<div id="about-info">
		   ...
		   <!-- <header>
			...
			<div class="container">
					...
					<div class="row-fluid">
						<div class="span12"><p style="text-align:center;"> <iframe width="500" height="281" src="https://www.youtube.com/embed/mxd7SulqFnM?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe></p>	
...
<footer id="footer">
	...
	<div class="row">
		...
		<div class="row">
		<div class="span12">
			<h5><a href="https://culverhouse.ua.edu/directory/profile/cchamber" target="_blank">Connie Chambers</a> - <span>Director of Corporate Partnerships</span></h5>
			Email: <a href="mailto:cchamber@culverhouse.ua.edu">cchamber@culverhouse.ua.edu</a></br>
			Phone: <a href="tel:2053484503">205-348-4503</a>
		</div>
		</div
		<div class="row">
			<div class="span3">
				<h5>Culverhouse College of Commerce</h5>
				<p><a href="https://culverhouse.ua.edu" target="_blank">http://culverhouse.ua.edu</a></p>
			</div>
			<div class="span3">
				<h5>Manderson Graduate School of Business</h5>
				<p><a href="https://culverhouse.ua.edu/graduate-programs" target="_blank">https://culverhouse.ua.edu/graduate-programs</a></p>
			</div>
			<div class="span3">
				<h5>The University of Alabama</h5>
				<p><a href="http://www.ua.edu" target="_blank">http://www.ua.edu</a></p>
			</div>
		</div>
	</div>
</footer>
