...
<div style='width:600px;border:1px solid #DBDBDB;border-radius:6px;background-color:#fff; overflow:hidden;'>
  <div style='background-color:#9E1B32;height:100px;border-radius:6px 6px 0 0;box-shadow:0px 0px 10px 0px #ccc;border-bottom:1px solid #1067A0;'>
    <div style='float:left;' align='left'>
      <div style='color:#fff;font-size:30px;font-weight:bold;padding:24px 0 0 20px;text-shadow:2px 1px 1px #0B456C;'>2015 CLDC Application</em></div>
      <div style='color:#D7ECFB;padding:0 0 0 20px; font-size:14px;text-shadow:1px 1px 1px #0B456C;'>You have got an online application for the 2015 Culverhouse Leadership Diversity Case Competition<em></em></div>
  ...
  <div align='left' style='padding:10px 30px; text-align:justify; color:#666; font-size:13px;line-height:22px;'>
	...
	<p> 
	  ...
	  <em>Team Member 4 Name:</em> $ssFourthMemberName<br/>
      <em>Team Member 4 Email:</em> $ssFourthMemberEmail<br/>
					...
					<nav id="header-nav">
						<div class="navbar">
							<div class="navbar-inner">
								<div class="container">
									<a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"><i class="icon-align-justify icon-white"></i> Navigation</a>
									<div class="nav-collapse collapse">
										<ul class="nav">
											<li><a href="#about">About The Competition</a></li>
											<li><a href="#guidelines">Guidelines</a></li>
											<li><a href="2016StudentAgenda.pdf" target="_blank">2016 CLDC Schedule</a></li>
											<li><a href="#venue">Venue</a></li>
											<li><a href="#tickets">Register</a></li> 
											<li><a href="#judges">Judges</a></li>
                                            						<li><a href="#sponsors">Sponsors</a></li>
                                            						<li><a href="#speakers">Committee</a></li>
											<li><a href="#faq">FAQ</a></li>
											<li><a href="mailto:cchamber@culverhouse.ua.edu">Contact</a></li> 
										</ul>
									</div>
								</div>
							</div>
...
corporate executives who serve as a panel of judges. The top three teams receive cash awards.</p>
							...
							<p><a href="#tickets" class="btn">Team Registration</a></p>
						</div>
...
<div id="guidelines">
	<div class="container">
		...
		<div class="row-fluid">
						<div class="span12">	
						  <ul>
						    <li>All teams are responsible for their own travel arrangements.The Culverhouse College of Commerce will provide hotel accommodations for two nights, Thursday and Friday. No more than three rooms per team, two for the student team members and one for the team advisor, will be reserved.</li>
					      </ul>
						  <p><strong><h3>Team Makeup</h3></strong></p><ul>
                              <li>Teams must consist of four undergraduate students in their junior or senior year of college, a majority of the team must be from underrepresented populations in business. A team captain must be identified at registration.</li>
                                <li>Diversity must be represented in the team. Heterogeneous teams will likely have the advantage of addressing the case issues from a variety of perspectives. </li>
                                <li>All interested students should form teams of 4 students. Only teams, not individuals, can compete.</li>
                                <li>Each team must submit a team name as well as designate a team captain. All submissions and communications should be conducted by the team captain. </li>
                                <li>Each team must have a professional advisor, such as an academic professor, organization director or career center representative. The advisor must attend the competition but not help with the team presentation. Advisors must be a full time employee of the college.</li>
                                </ul>
						  <p><strong><h3>Event Rules</h3></strong></p>
						  <ul>
						    <li>The competition case will be distributed the evening of Thursday January 28th, 2016. The case will not require teams to have technical knowledge, financial or otherwise, to be successful.</li>
						  ...
						  <p><strong><em>After each  team has presented </em></strong> judges will conduct a question and answer period.  The team needs to be prepared to defend the recommendation  in a respectful and compelling manner. The question and answer period evaluates thought processes and research used in the proposal.</p>
						  <p>Presentation clarity will be evaluated on the coherence of the presentation, the seamless presentation flow, ability to respond well during the question and answer period and the PowerPoint design style. </p>
...
<div id="tickets">
	<div class="container">
		...
		<div class="row">
			<div class="span12 nobottom">
				<header>
					<h2 class="title">Team Registration <span></span></h2>
				</header>
			</div>
		</div>
		...
		<div class="row">
			<div class="span12">
				<div class="well">
					<h3>To participate, teams of 4 students must register by December 11, 2015 at 11:59pm CST.</h3>
                  <p>Teams must consist of four undergraduate students in their junior or senior year of college, a majority of the team must be from underrepresented minorities. A team captain must be identified at registration.</p>
					<p>Each team must submit a team name as well as designate a team captain. All submissions and communications should be conducted by the team captain. Registration closes at 11:59pm CST on December 11, 2015</p>
    ...
    <div class="control-group">
      <label class="control-label text-info">Attach four resumes (Hit Browse, then hold Shift and select the files)
				...
				<div class="span12">
					...
					<div class="row-fluid">
                        ...
                        <div class="span6 nobottom">
							<div class="speaker">
								<!--<img src="img/dummyspeaker.jpg" alt="" class="speaker-photo">-->
								<h3 class="speaker-name">Seve gunter </h3>
                                <p class="speaker-job">2nd year MBA </p>
							
                                <p>Guntersville, Alabama</p>
								<div class="clearfix"></div>
							</div>
						</div>
                        </div>
...
We will be providing hotel lodging and food for participants once they arrive to campus.  For teams beyond 300 miles from Tuscaloosa, AL, a travel stipend will be considered.  Please contact Connie Chambers at <a href="tel:2053484503"> (205) 348-4503</a> for more information.<br><br><br>  

<strong>3.  I do not have a business background.  Can I still apply?  Will I be at a disadvantage in the Competition?</strong><br>
A business background is not required to perform successfully in the Competition.  We are accepting applications from all disciplines – liberal arts, engineering, communications, etc.  Critical thinking and the ability to support an argument are the necessary skills for success in the Competition.  A current MBA or Manderson graduate student will be assigned to each team to act as an ambassador and provide any relevant assistance with the case.</strong><br><br><br>  
